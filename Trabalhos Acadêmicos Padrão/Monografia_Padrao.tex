...
\begin{dedicatoria}
    ...
    trabalho honesto. Por \textbf{\WenesTex}.
\end{dedicatoria}
% -----------------------------------------------
...
\textbf{Palavras-chaves}: Por \WenesTex; ABNT NBR 6028:2021; resumo informativo; parágrafo único; ponto e vírgula; relatório técnico; \abnTexUFT.
\end{resumo}
